...
function allfiles(icds,opss;savePath="./",filename="data",dataDirectory="/home/christoph/sid/data/GBA2014/KH-QBerichte/")
...
@time allfiles(["O80","O81","O82","Z38.0","Z38.1","Z38.2","Z38.3","Z38.4","Z38.5","Z38.6"],["5-72","5-724","5-73","5-732.2","5-740","5-741","5-742","5-749","5-749.0"];savePath="./",filename="data",dataDirectory="/home/christoph/sid/data/GBA2014/KH-QBerichte/");
...
function allfilesQI(ids,lbs;savePath="./",filename="dataQI",dataDirectory="/home/christoph/sid/data/GBA2014/AQUA-LQS-QBerichte/",varsString = ["EntwErg","QualBew","QualVgl","EmpBew"],varsFloat=["BErg","Erg","GG","BeobEreig","ErwEreig","RefBereich","VBBlow","VBBhigh","VBKlow","VBKhigh"])
...
@time allfilesQI(["11879","50103"],["09/3","PNEU"];savePath="./",filename="dataQI",dataDirectory="/home/christoph/sid/data/GBA2014/AQUA-LQS-QBerichte/",varsString = ["EntwErg","QualBew","QualVgl","EmpBew"],varsFloat=["BErg","Erg","GG","BeobEreig","ErwEreig","RefBereich","VBBlow","VBBhigh","VBKlow","VBKhigh"]);
