...
function allfiles(icds,opss;savePath="./",filename="data",dataDirectory="/home/christoph/sid/data/GBA2017/Berichte-Teile-A-B-C/")
...
function allfilesQI(ids,lbs;savePath="./",filename="dataQI",dataDirectory="/home/christoph/sid/data/GBA2017/Berichte-Teile-A-B-C/",varsString = ["EntwErg","QualBew","QualVgl"],varsFloat=["BErg","Erg","GG","BeobEreig","ErwEreig","RefBereich","VBBlow","VBBhigh","VBKlow","VBKhigh"])
...
allfilesQI(["54143","54141"],["09/3","HCH"];savePath="./",filename="dataQI",dataDirectory="/home/christoph/sid/data/GBA2017/Berichte-Teile-A-B-C/",varsString = ["EntwErg","QualBew","QualVgl"],varsFloat=["BErg","Erg","GG","BeobEreig","ErwEreig","RefBereich","VBBlow","VBBhigh","VBKlow","VBKhigh"])
