...
It is often useful to get some summary statistics for subgroups (this is similar to "Pivot tables" in Excel). The "by" function takes a data frame, a variable by which the df is split into subgroups (e.g. all people with the same age are a subgroup) and a third argument that tells Julia what to do with each subgroup (e.g. compute the average height). The third argument can be specified in several ways (and several third arguments can be provided). The function "groupby" simply gives several sub dataframes -- one for each group. The "aggregate" function applies a function (e.g. mean) to all variables of the original dataset by group.
...
#+BEGIN_SRC julia :exports both :returns output :tangle yes :results output 
  ...
  by(df, :age, :height => mean)

  by(df, :age, AvgHeight = :height => mean, n = :height => length)

  by(df, :age, [:height,:weight] => x -> (Avg_BMI=mean(x.weight./(x.height/100).^2),AvgHeight=mean(x.height)))

  for group in groupby(df,:age)
      println(describe(group))
  end

  aggregate(df[:,2:4], :age, mean)

  aggregate(df[:,2:4], :age, [mean,std])
...
2×3 DataFrame
│ Row │ age   │ height_mean │ weight_mean │
│     │ Int64 │ Float64     │ Float64     │
├─────┼───────┼─────────────┼─────────────┤
│ 1   │ 20    │ 165.5       │ 64.0        │
│ 2   │ 26    │ 174.5       │ 67.0        │
2×5 DataFrame
│ Row │ age   │ height_mean │ weight_mean │ height_std │ weight_std │
│     │ Int64 │ Float64     │ Float64     │ Float64    │ Float64    │
├─────┼───────┼─────────────┼─────────────┼────────────┼────────────┤
│ 1   │ 20    │ 165.5       │ 64.0        │ 7.77817    │ 5.65685    │
│ 2   │ 26    │ 174.5       │ 67.0        │ 7.77817    │ 4.24264    │
#+end_example


Sometimes it can be useful to check for frequencies in the data. The function "countmap" is a simple version to see the number of occurences. The package FreqTables.jl provides support for multidimensional frequency tables. The "prop" function transforms number of occurences to proportions.
...
The package DataFramesMeta.jl provides some macros that allow to do some of the above mentioned operations in an easier (to read) way. Note that variables are here always referenced with :variablename.
...
@df df corrplot(cols(1:3),grid=false)
...
├─────┼──────────┼─────────────┼──────────┤
│ 1   │ 0.512183 │ 0.792823    │ 2.26093  │
│ 2   │ 0.666161 │ 0.762571    │ 1.01085  │
│ 3   │ 1.02133  │ -0.269914   │ 7.32926  │
│ 4   │ 1.57975  │ -1.40416    │ -3.41152 │
│ 5   │ 1.50258  │ 1.75011     │ 7.60597  │
│ 6   │ 1.61688  │ -0.249053   │ 3.31941  │
│ 7   │ 1.83522  │ -0.381234   │ -7.15758 │
│ 8   │ 1.64072  │ -0.521099   │ 9.14957  │
│ 9   │ 2.12591  │ 0.835948    │ 5.21143  │
│ 10  │ 2.48898  │ 0.160975    │ 9.76434  │
│ 11  │ 2.36749  │ -0.525752   │ 10.3422  │
│ 12  │ 2.83173  │ -0.937603   │ 14.2172  │
│ 13  │ 2.94072  │ 0.202791    │ 11.987   │
│ 14  │ 3.48163  │ 1.07823     │ 17.4306  │
│ 15  │ 3.59517  │ -0.0771991  │ 8.54042  │
│ 16  │ 3.9784   │ -0.0991558  │ 21.0468  │
│ 17  │ 3.84418  │ -0.25526    │ 20.2725  │
│ 18  │ 4.20597  │ 0.00345279  │ 19.2394  │
│ 19  │ 4.02645  │ 0.423793    │ 25.8005  │
│ 20  │ 4.11836  │ 1.042       │ 19.2409  │
│ 21  │ 4.44222  │ 0.0822501   │ 33.4813  │
│ 22  │ 5.05977  │ -0.919206   │ 24.4378  │
│ 23  │ 5.01899  │ 1.09166     │ 19.5762  │
│ 24  │ 5.43661  │ 0.138596    │ 27.77    │
│ 25  │ 5.22667  │ 1.32464     │ 25.0279  │
│ 26  │ 5.2222   │ 0.369197    │ 28.6333  │
│ 27  │ 6.17476  │ -0.494456   │ 20.2039  │
│ 28  │ 5.85477  │ 0.439682    │ 28.4415  │
│ 29  │ 5.93579  │ 0.371636    │ 24.1148  │
│ 30  │ 6.7246   │ -0.0944293  │ 33.311   │
│ 31  │ 6.39421  │ -1.49756    │ 33.0757  │
│ 32  │ 6.76791  │ -0.10675    │ 38.2243  │
│ 33  │ 7.0449   │ -0.966399   │ 29.5458  │
│ 34  │ 7.44418  │ -1.45609    │ 40.582   │
│ 35  │ 7.58868  │ 0.474549    │ 37.6216  │
│ 36  │ 7.65054  │ 1.3497      │ 37.5648  │
│ 37  │ 7.69516  │ -1.11689    │ 36.9342  │
│ 38  │ 7.92586  │ -0.360171   │ 41.0838  │
│ 39  │ 7.88195  │ -0.0249097  │ 32.5937  │
│ 40  │ 8.63629  │ -1.27805    │ 45.1951  │
│ 41  │ 8.37961  │ -1.07027    │ 36.8256  │
│ 42  │ 8.4368   │ -1.14606    │ 49.5938  │
│ 43  │ 9.35644  │ 0.299216    │ 45.0796  │
│ 44  │ 9.18181  │ -0.410604   │ 39.8708  │
│ 45  │ 9.60298  │ -1.54688    │ 52.376   │
│ 46  │ 9.29101  │ 0.184142    │ 30.348   │
│ 47  │ 10.1056  │ 1.05034     │ 47.4922  │
│ 48  │ 10.2762  │ 1.00941     │ 45.6267  │
│ 49  │ 10.4844  │ -0.744914   │ 54.3798  │
│ 50  │ 10.4633  │ 0.305245    │ 51.8302  │
│ 51  │ 10.9297  │ -1.48341    │ 52.2389  │
│ 52  │ 10.4048  │ 1.42553     │ 43.8647  │
│ 53  │ 11.1496  │ 2.03498     │ 52.427   │
│ 54  │ 11.4866  │ 0.334934    │ 52.6687  │
│ 55  │ 11.5661  │ -0.316114   │ 55.1773  │
│ 56  │ 11.2984  │ -0.457972   │ 51.4885  │
│ 57  │ 11.9883  │ 1.07167     │ 60.229   │
│ 58  │ 11.8113  │ -0.780198   │ 54.9072  │
│ 59  │ 12.3489  │ 1.62358     │ 57.1793  │
│ 60  │ 12.2878  │ 0.160234    │ 54.3168  │
│ 61  │ 12.9077  │ -0.695043   │ 72.2136  │
│ 62  │ 12.8504  │ 1.2852      │ 59.0271  │
│ 63  │ 13.0334  │ -1.10126    │ 58.4729  │
│ 64  │ 12.8783  │ 0.510835    │ 62.5861  │
│ 65  │ 13.3062  │ -0.914152   │ 54.6793  │
│ 66  │ 13.6566  │ 0.940438    │ 59.0264  │
│ 67  │ 14.108   │ -0.00670695 │ 61.2666  │
│ 68  │ 14.378   │ 0.946354    │ 70.4364  │
│ 69  │ 14.3512  │ -1.00471    │ 65.6835  │
│ 70  │ 14.2383  │ 0.307798    │ 73.8223  │
│ 71  │ 14.4011  │ 0.976613    │ 74.7944  │
│ 72  │ 14.411   │ 1.20051     │ 86.0273  │
│ 73  │ 15.2362  │ 0.563279    │ 70.6351  │
│ 74  │ 15.4013  │ -0.58278    │ 72.0383  │
│ 75  │ 15.2542  │ 0.195487    │ 72.8219  │
│ 76  │ 15.2328  │ -1.85821    │ 76.9436  │
│ 77  │ 15.5104  │ 1.14901     │ 72.2947  │
│ 78  │ 16.1357  │ -0.804262   │ 79.086   │
│ 79  │ 16.0728  │ -0.0353501  │ 76.7965  │
│ 80  │ 16.7621  │ 2.37294     │ 79.1994  │
│ 81  │ 16.9477  │ -1.481      │ 83.2339  │
│ 82  │ 16.6242  │ 1.82292     │ 79.1454  │
│ 83  │ 16.8899  │ 0.881392    │ 86.6735  │
│ 84  │ 17.28    │ -0.405419   │ 91.6585  │
│ 85  │ 17.2984  │ 0.145448    │ 96.1339  │
│ 86  │ 17.6153  │ 0.00143833  │ 83.472   │
│ 87  │ 17.9969  │ -0.200073   │ 85.0427  │
│ 88  │ 18.3149  │ -0.184262   │ 85.1796  │
│ 89  │ 18.3546  │ -0.338025   │ 87.5125  │
│ 90  │ 18.2743  │ 1.0114      │ 92.3219  │
│ 91  │ 18.7246  │ 0.249778    │ 84.8416  │
│ 92  │ 18.4528  │ 0.332055    │ 97.33    │
│ 93  │ 18.6304  │ 0.452801    │ 104.664  │
│ 94  │ 19.0548  │ -0.840774   │ 90.8554  │
│ 95  │ 19.6722  │ -0.15014    │ 100.341  │
│ 96  │ 19.3672  │ -0.265219   │ 93.4471  │
│ 97  │ 20.0288  │ -1.14863    │ 100.292  │
│ 98  │ 19.9991  │ -0.879081   │ 96.2472  │
│ 99  │ 20.3104  │ 0.167355    │ 97.0132  │
│ 100 │ 20.7149  │ 1.60987     │ 98.6726  │
#+end_example
